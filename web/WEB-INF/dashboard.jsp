...
<div class="d-flex min-vh-100">
    ...
    <div class="sidebar d-flex flex-column p-3 shadow" id="sidebar">
        <div class="text-center mb-4 mt-2 text-nowrap">
            <h4 class="fw-bold text-white"><i class="fa-solid fa-chart-pie text-primary me-2"></i>BillManager</h4>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-xl-3 col-md-6">
                <div class="summary-box">
                    <h4>Total Revenue</h4>
                    <h3 class="text-success">$<%= data.get("TOTAL_REVENUE")%></h3>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="summary-box">
                    ...
                    <h3 class="text-primary"><%= data.get("TOTAL_INVOICE")%></h3>
