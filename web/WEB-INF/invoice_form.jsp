...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { background-color: #f8f9fa; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #212529; line-height: 1.5; }
        .container { width: 100%; max-width: 900px; margin: 3rem auto; padding: 0 15px; } /* Mở rộng max-width một chút cho bảng đẹp hơn */
        .invoice-card { background-color: #fff; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); padding: 2rem; }
        .card-header-flex { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; }
        .header-title { font-size: 2rem; font-weight: bold; color: #0d6efd; }
        .header-title i { margin-right: 0.5rem; }
        .badge { background-color: #0dcaf0; color: #000; padding: 0.4em 0.8em; border-radius: 50rem; font-size: 0.9em; font-weight: 700; }
        .row { display: flex; flex-wrap: wrap; margin-left: -10px; margin-right: -10px; row-gap: 1rem; }
        ...
        .form-label { display: inline-block; margin-bottom: 0.5rem; font-weight: 600; color: #495057; }
        .form-control { display: block; width: 100%; padding: 0.6rem 0.75rem; font-size: 1rem; font-family: inherit; color: #212529; background-color: #fff; border: 1px solid #ced4da; border-radius: 0.375rem; transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out; }
        .form-control:focus { border-color: #86b7fe; outline: 0; box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25); }
        .form-control-lg { padding: 0.75rem 1rem; font-size: 1.25rem; font-weight: bold; color: #0d6efd;}
        .text-end { text-align: right; }
        .input-group { display: flex; align-items: stretch; width: 100%; }
        .input-group .form-control { border-top-right-radius: 0; border-bottom-right-radius: 0; flex: 1 1 auto; }
        .input-group-text { display: flex; align-items: center; padding: 0.75rem 1rem; font-size: 1rem; font-weight: 400; line-height: 1.5; color: #495057; text-align: center; white-space: nowrap; background-color: #e9ecef; border: 1px solid #ced4da; border-left: 0; border-top-right-radius: 0.375rem; border-bottom-right-radius: 0.375rem; }
        .meta-text small { display: block; font-size: 0.875em; color: #6c757d; }
        .mt-4 { margin-top: 1.5rem; }
        hr { margin: 2rem 0; color: inherit; background-color: transparent; border: 0; border-top: 1px solid rgba(0,0,0,0.1); }
        .actions { display: flex; justify-content: flex-end; gap: 0.5rem; }
        .btn { display: inline-block; font-weight: 400; line-height: 1.5; text-align: center; text-decoration: none; vertical-align: middle; cursor: pointer; border: 1px solid transparent; font-size: 1rem; transition: all 0.15s; border-radius: 0.375rem; }
        .btn-light { color: #000; background-color: #f8f9fa; border-color: #f8f9fa; padding: 0.6rem 1.5rem; }
        .btn-light:hover { background-color: #e2e6ea; border-color: #dae0e5; }
        .btn-save { background-color: #0d6efd; color: white; padding: 0.6rem 1.5rem; }
        .btn-save:hover { background-color: #0b5ed7; }
        .btn-add { background-color: #198754; color: white; padding: 0.6rem 1rem; width: 100%; height: 100%;}
        .btn-add:hover { background-color: #157347; }
        .btn-delete { color: #dc3545; background: none; border: none; cursor: pointer; font-size: 1.2rem; }
        .btn-delete:hover { color: #a52834; }

        /* Style cho bảng giỏ hàng */
        .cart-section { background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 1.5rem; margin-top: 1.5rem; }
        .table { width: 100%; border-collapse: collapse; margin-top: 1rem; background: #fff; }
        .table th, .table td { padding: 1rem; border-bottom: 1px solid #dee2e6; text-align: left; }
