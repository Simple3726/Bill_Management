...
<head>
    ...
    body, html {
        ...
        overflow-x: hidden; /* Ngăn chặn cuộn ngang khi sidebar trượt ra ngoài */
    }
...
<div class="d-flex min-vh-100">
    ...
    <div class="sidebar d-flex flex-column p-3 shadow" id="sidebar">
        <div class="text-center mb-4 mt-2 text-nowrap">
            <h4 class="fw-bold text-white"><i class="fa-solid fa-file-invoice-dollar text-primary me-2"></i>BillManager</h4>
        </div>
