                    ...
                    <div class="card-body p-0 table-responsive">
                        <table class="table table-hover align-middle mb-0 text-nowrap">
                            <thead class="table-dark">
                                <tr><th class="ps-4 py-3">Shift ID</th><th>User ID</th><th>Start Time</th><th>End Time</th><th>Status</th><th class="text-center pe-4">Action</th></tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-5"><i class="fa-solid fa-clock mb-3" style="font-size: 40px; color: #dee2e6;"></i><br><h5>No Data</h5><p class="mb-0">No work shift has been recorded yet.</p></td>
                                </tr>
                                <% }%>
                            </tbody>
                        </table>
