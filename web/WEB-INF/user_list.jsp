                            ...
                            <table class="table table-hover align-middle mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="d-flex align-items-center"><div class="bg-light rounded-circle d-flex justify-content-center align-items-center me-3" style="width: 35px;
                                                                                        height: 35px;"><i class="fa-solid fa-user text-secondary"></i></div><strong><%=u.getUsername()%></strong></div></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <% } else if ("OFFLINE".equals(u.getStatus())) { %>
                                            <span class="custom-badge badge-offline">
                                                <i class="fa-solid fa-circle-dot me-1"></i>OFFLINE
                                            </span>
                                            <% } else { %>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center text-muted py-5"><i class="fa-solid fa-users-slash mb-3" style="font-size: 40px;
                                                                                               color: #dee2e6;"></i><br><h5>No Data</h5><p class="mb-0">No users have been created in the system yet.</p></td>
                                    </tr>
                                    <% }%>
                                </tbody>
                            </table>
